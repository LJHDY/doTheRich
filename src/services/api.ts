...
export const getNationalGapStats = async (tradeMonth?: string): Promise<NationalGapResponse> => {
  ...
  // 백엔드가 이미 camelCase로 반환하므로 그대로 통과
  const stats: NationalDistrictStat[] = (data.items || []).map((r: any): NationalDistrictStat => ({
    id: r.id,
    tradeMonth: r.tradeMonth,
    regionCode: r.regionCode,
    regionName: r.regionName,
    province: r.province,
    cityType: r.cityType,
    population: r.population,
    avgTrade15: r.avgTrade15 ?? null,
    avgTrade18: r.avgTrade18 ?? null,
    avgTrade21: r.avgTrade21 ?? null,
    avgTrade24: r.avgTrade24 ?? null,
    avgTrade26: r.avgTrade26 ?? null,
    avgTrade33: r.avgTrade33 ?? null,
    avgJeonse15: r.avgJeonse15 ?? null,
    avgJeonse18: r.avgJeonse18 ?? null,
    avgJeonse21: r.avgJeonse21 ?? null,
    avgJeonse24: r.avgJeonse24 ?? null,
    avgJeonse26: r.avgJeonse26 ?? null,
    avgJeonse33: r.avgJeonse33 ?? null,
    tradeCount15: r.tradeCount15 ?? null,
    tradeCount18: r.tradeCount18 ?? null,
    tradeCount21: r.tradeCount21 ?? null,
    tradeCount24: r.tradeCount24 ?? null,
    tradeCount26: r.tradeCount26 ?? null,
    tradeCount33: r.tradeCount33 ?? null,
    jeonseCount15: r.jeonseCount15 ?? null,
    jeonseCount18: r.jeonseCount18 ?? null,
    jeonseCount21: r.jeonseCount21 ?? null,
    jeonseCount24: r.jeonseCount24 ?? null,
    jeonseCount26: r.jeonseCount26 ?? null,
    jeonseCount33: r.jeonseCount33 ?? null,
    collectedAt: r.collectedAt,
  }));

  return {
    tradeMonth: data.tradeMonth,
